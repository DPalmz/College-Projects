...
def main():
    ...
    model = TransfomerEncoderDecoderModel(num_layers=args.num_layers, hidden=args.hidden_size, num_heads=args.num_heads, 
                                            ...
                                            src_vocab_size=len(source_tokenizer.max_model_input_sizes), 
                                            tgt_vocab_size=len(target_tokenizer.max_model_input_sizes), dropout=args.dropout_rate)
